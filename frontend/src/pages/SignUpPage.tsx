    ...
    try {
      const accessToken =
        provider === "google"
          ...
          : await beginFacebookLogin();
      const res = await socialLoginRequest({ provider, accessToken });
      login(
        {
          id: res.userId,
          name: res.fullName,
          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-2 gap-3 mt-6">
              ...
              >
                ...
                {socialLoading === "google" ? t.common.loading : "Google"}
              </Button>
              <Button
                variant="outline"
                className="w-full"
              ...
              >
                ...
                {socialLoading === "facebook" ? t.common.loading : "Facebook"}
              </Button>
            </div>
          </div>
          </>
